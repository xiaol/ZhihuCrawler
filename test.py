...
def question_test(url):
    ...
    # 获取排名前十的十个回答
    top_answers = question.get_top_i_answers(119)
    # 获取所有回答
...
def test():
    ...
    for collection in user_collections:
        ...
        # 得到该收藏夹下的前十个回答
        top_answers = collection.get_top_i_answers(19)
        # 把答案内容转成txt，markdown
...
def main():
    # http://www.zhihu.com/question/00000002
    # url = "http://www.zhihu.com/question/24269892"
    url ="https://www.zhihu.com/question/29888808"
    question_test(url)
